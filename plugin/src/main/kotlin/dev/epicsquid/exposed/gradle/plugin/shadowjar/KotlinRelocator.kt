package dev.epicsquid.exposed.gradle.plugin.shadowjar
...
import dev.epicsquid.exposed.gradle.plugin.shadowjar.KotlinRelocator.Companion.storeRelocationPath
...
private class KotlinRelocator(private val task: ShadowJar, private val delegate: SimpleRelocator) :
